...
describe('react-ui-alert', () => {
  ...
  describe('react-ui-alert with one Provider and minimum needed options', () => {
    let tree
  ...
  describe('react-ui-alert with one Provider and different types of alerts', () => {
  ...
  describe('react-ui-alert with one Provider and custom options', () => {
  ...
  describe('react-ui-alert with multiple Providers', () => {
